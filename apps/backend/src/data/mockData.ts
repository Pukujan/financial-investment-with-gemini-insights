export const mockStocks = [
  ...
  // Additional large caps (catalog ~100 symbols for Tiingo daily refresh)
  { symbol: 'IBM', name: 'International Business Machines', price: 178.23, change: 2.12, changePercent: 1.20, marketCap: '$165B', volume: '4.2M', pe: 22.1, sector: 'Technology' },
  { symbol: 'CSCO', name: 'Cisco Systems Inc.', price: 52.34, change: 0.78, changePercent: 1.51, marketCap: '$210B', volume: '18.4M', pe: 16.8, sector: 'Technology' },
  { symbol: 'NOW', name: 'ServiceNow Inc.', price: 812.45, change: 14.23, changePercent: 1.78, marketCap: '$168B', volume: '1.1M', pe: 98.4, sector: 'Technology' },
  { symbol: 'UBER', name: 'Uber Technologies Inc.', price: 67.89, change: 1.45, changePercent: 2.18, marketCap: '$142B', volume: '12.3M', pe: 45.2, sector: 'Technology' },
  { symbol: 'ABNB', name: 'Airbnb Inc.', price: 134.56, change: 2.89, changePercent: 2.20, marketCap: '$86B', volume: '5.6M', pe: 18.7, sector: 'Consumer Cyclical' },
  { symbol: 'PYPL', name: 'PayPal Holdings Inc.', price: 62.34, change: 0.89, changePercent: 1.45, marketCap: '$68B', volume: '9.8M', pe: 14.2, sector: 'Financial Services' },
  { symbol: 'BRK-B', name: 'Berkshire Hathaway Inc.', price: 412.67, change: 3.45, changePercent: 0.84, marketCap: '$890B', volume: '3.1M', pe: 9.2, sector: 'Financial Services' },
  { symbol: 'ENPH', name: 'Enphase Energy Inc.', price: 112.34, change: -2.34, changePercent: -2.04, marketCap: '$15B', volume: '6.7M', pe: 28.4, sector: 'Energy' },
  { symbol: 'ISRG', name: 'Intuitive Surgical Inc.', price: 378.45, change: 5.67, changePercent: 1.52, marketCap: '$135B', volume: '0.9M', pe: 62.3, sector: 'Healthcare' },
  { symbol: 'DE', name: 'Deere & Company', price: 378.23, change: 4.12, changePercent: 1.10, marketCap: '$105B', volume: '1.4M', pe: 12.8, sector: 'Industrials' },
  { symbol: 'TJX', name: 'The TJX Companies Inc.', price: 98.45, change: 1.23, changePercent: 1.26, marketCap: '$112B', volume: '4.5M', pe: 26.4, sector: 'Consumer Cyclical' },
  { symbol: 'ACN', name: 'Accenture plc', price: 345.67, change: 4.56, changePercent: 1.34, marketCap: '$218B', volume: '2.1M', pe: 28.9, sector: 'Technology' },
  { symbol: 'HON', name: 'Honeywell International Inc.', price: 198.34, change: 2.45, changePercent: 1.25, marketCap: '$128B', volume: '2.8M', pe: 22.7, sector: 'Industrials' },
  { symbol: 'LRCX', name: 'Lam Research Corporation', price: 78.45, change: 2.34, changePercent: 3.07, marketCap: '$102B', volume: '11.2M', pe: 24.6, sector: 'Semiconductors' },
];
